...
const CertainProductComponent = () => {
  ...
  useEffect(() => {
    const url = `https://bucollections-api.onrender.com/product/${id}`;
    ...
    const fetchRating = async () => {
      try {
        const apiUrl = `https://bucollections-api.onrender.com/rating/${id}`;
        const headers = {
    ...
    const fetchReviews = async () => {
      try {
        const apiUrl = `https://bucollections-api.onrender.com/review/${id}`;
        const headers = {
          "Content-Type": "application/json",
          Authorization: localStorage.getItem("token"),
        };
