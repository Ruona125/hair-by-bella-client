...
const CartComponent = () => {
  ...
  const handleCreateOrder = () => {
    ...
    axios
      .post("https://bucollections-api.onrender.com/order", orderData, {
        headers: {
          "Content-Type": "application/json",
          Authorization: localStorage.getItem("token"),
        },
  ...
  const onToken = (token) => {
    ...
    fetch("https://bucollections-api.onrender.com/payment", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDeleteCart = (cartId) => {
    axios
      .delete(`https://bucollections-api.onrender.com/cart/${cartId}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: localStorage.getItem("token"),
        },
  ...
  const updateCartOnServer = (cartId, updatedCarts) => {
    const url = `https://bucollections-api.onrender.com/cart/${cartId}`;
    const headers = {
      "Content-Type": "application/json",
      Authorization: localStorage.getItem("token"),
    };
